...
struct proc {
  ...
  struct proc *parent_proc;   // Points to main process if this is a thread
  int thread_id;              // Unique thread ID within process
  void *thread_stack;         // User stack for this thread
  uint64 thread_stack_size;   // Size of user stack
